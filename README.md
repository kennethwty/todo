# todolist-jquery
<h1>Screenshots of the To-Do list:</h1><br>
...
<br>
3 & 4) When you are done with a task, simply click on it and it will get crossed off. You can also use the trash can icon instead.
<br>
